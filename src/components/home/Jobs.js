...
class Jobs extends Component {
  ...
  render() {
    return ( <
      ...
      <
      a href = "https://github.com/golang-vietnam/jobs"
      target = "_blank"
      ...
      Post a job <
      /a> <
      a href = "https://github.com/golang-vietnam/job_board/issues"
      target = "_blank"
      rel = "noopener noreferrer"
      css = {
        `
      ...
      disabled = {
        this.state.items.length <= this.state.display
      } >
      <
      IoIosArrowRoundForward / >
      <
